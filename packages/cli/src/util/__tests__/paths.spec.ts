            ...
            path: [
              {
                ...
                examples: [{ id: faker.lorem.word(), key: 'foo', value: 'test' }],
              },
            ],
          },
            ...
            query: [
              {
                ...
                examples: [{ id: faker.lorem.word(), key: 'foo', value: { a: { aa: 1, ab: 2 } } }],
              },
            ],
          },
          responses: [{ id: faker.lorem.word(), code: '200' }],
            ...
            query: [
              {
                ...
                name: 'p',
                style: HttpParamStyles.DeepObject,
                examples: [{ id: faker.lorem.word(), key: 'foo', value: exampleValue }],
              },
            ],
          },
          responses: [{ id: faker.lorem.word(), code: '200' }],
            ...
            query: [
              {
                ...
                name: 'p',
                style: HttpParamStyles.DeepObject,
                examples: [{ id: faker.lorem.word(), key: 'foo', value: { a: null } }],
              },
            ],
          },
          responses: [{ id: faker.lorem.word(), code: '200' }],
            ...
            query: [
              {
                ...
                examples: [{ id: faker.lorem.word(), key: 'foo', value: [1, 2, 3] }],
              },
            ],
          },
          responses: [{ id: faker.lorem.word(), code: '200' }],
            ...
            query: [
              {
                ...
                name: 'StartTime>',
                style: HttpParamStyles.Form,
                examples: [{ id: faker.lorem.word(), key: 'foo', value: '1985-10-25T03:33:00.613Z' }],
              },
            ],
          },
          responses: [{ id: faker.lorem.word(), code: '200' }],
          ...
          request: {
            path: [
              {
                ...
                name: 'p1',
                style: HttpParamStyles.Simple,
                examples: [{ id: faker.lorem.word(), key: 'foo', value: 'test1' }],
              },
              {
                id: faker.lorem.word(),
                name: 'p2',
                style: HttpParamStyles.Label,
                examples: [{ id: faker.lorem.word(), key: 'foo', value: ['test1', 'test2'] }],
              },
              {
                id: faker.lorem.word(),
                name: 'p3',
            ...
            query: [
              ...
              },
              {
                ...
                style: HttpParamStyles.DeepObject,
                examples: [
                  { id: faker.lorem.word(), key: 'foo', value: { a: ['test1', 'test2'], b: { ba: 1, bb: 2 } } },
                ],
              },
            ],
          },
