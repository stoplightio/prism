  ...
  describe('request media type is not provided', () => {
    it('returns no validation errors', () => {
      assertRight(
        validate(
          'test',
          [{ id: faker.lorem.word(), mediaType: 'application/not-exists-son', examples: [], encodings: [] }],
  ...
  describe('body schema is provided', () => {
    it('return validation errors', () => {
      ...
      assertLeft(
        validate(
          'test',
          [{ id: faker.lorem.word(), mediaType: 'application/json', schema: mockSchema, examples: [], encodings: [] }],
          ValidationContext.Input,
          'application/json'
        ),
        error =>
