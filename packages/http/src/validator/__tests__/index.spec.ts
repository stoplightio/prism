      ...
      describe('request.body is set', () => {
        describe('request body is not required', () => {
          it(
            ...
            validate({ request: { body: { id: faker.lorem.word(), required: false, contents: [] } } }, undefined, 0)
          );
        });
            ...
            validate(
              {
                ...
                path: '/',
                id: '1',
                request: { body: { id: faker.lorem.word(), contents: [], required: true } },
                responses: [{ id: faker.lorem.word(), code: '200' }],
              },
              undefined,
              1
            ...
            validate(
              {
                request: {
                  query: [
                    { id: faker.lorem.word(), style: HttpParamStyles.SpaceDelimited, name: 'hey', required: true },
                  ],
                },
              },
              undefined,
          ...
          it('calls the path validator', () => {
            validator.validateInput({
              resource: {
                ...
                request: {
                  path: [
                    { id: faker.lorem.word(), name: 'a', style: HttpParamStyles.Simple },
                    { id: faker.lorem.word(), name: 'b', style: HttpParamStyles.Matrix },
                  ],
                },
                responses: [{ id: faker.lorem.word(), code: '200' }],
              },
          ...
          it('calls the path validator', () => {
            validator.validateInput({
              resource: {
                ...
                request: {
                  path: [
                    { id: faker.lorem.word(), name: 'a-id', style: HttpParamStyles.Simple },
                    { id: faker.lorem.word(), name: 'b-id', style: HttpParamStyles.Matrix },
                  ],
                },
                responses: [{ id: faker.lorem.word(), code: '200' }],
              },
                ...
                responses: [
                  {
                    id: faker.lorem.word(),
                    code: '200',
                    contents: [{ id: faker.lorem.word(), mediaType: 'application/json' }],
                  },
                ],
              },
