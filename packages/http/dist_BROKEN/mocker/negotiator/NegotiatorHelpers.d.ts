...
declare const helpers: {
    ...
    negotiateOptionsForInvalidRequest(httpResponses: IHttpOperationResponse[], statusCodes: NonEmptyArray<number>, exampleKey?: string | undefined): RE.ReaderEither<Logger, Error, IHttpNegotiationResult>;
};
