...
- Making a request to an operation with a `deprecated` parameter is no longer causing Prism to return a 422 response [#731](https://github.com/stoplightio/prism/pull/721)
