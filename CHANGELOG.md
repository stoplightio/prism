...
- By upgrading Json Schema Faker to the latest version, now the schemas with `additionalProperties:false` will be correctly handled when dynamic mocking is enabled [#719](https://github.com/stoplightio/prism/pull/719)
