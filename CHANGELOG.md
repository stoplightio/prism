...
- Requests lacking security credentials will return `401` error instead of the usual `422/400` validation error [#601](https://github.com/stoplightio/prism/pulls/601)
